...
public:
    ...
    lastfm::RadioStation station() const { return m_station; }
    lastfm::Track currentTrack() const {return m_track;}

	State state() const { return m_state; }

    Phonon::AudioOutput* audioOutput() const { return m_audioOutput; }

    void playNext( const lastfm::RadioStation& station );

public slots:
    void play( const lastfm::RadioStation& station );
    void skip();
    void stop();
...
signals:
    ...
    void tuningIn( const lastfm::RadioStation& );
